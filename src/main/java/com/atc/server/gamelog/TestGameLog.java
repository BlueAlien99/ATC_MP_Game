...
public class TestGameLog {
    public static void main(String[] args){
        ...
        log.insertEvent(1, "MOVEMENT", 1, UUID.randomUUID(),"Magda", 10,10,100,
                80,1200, UUID.randomUUID());
        log.insertEvent(1, "COLLISION", 1, UUID.randomUUID(),"Bartek", 10,10,100,
                80,1200, UUID.randomUUID());
        log.insertEvent(4, "COMMAND", 4, UUID.randomUUID(),"Rafał", 10,10,100,
                80,1200, UUID.randomUUID());
        ...
        List<Event> otherEvents = log.selectGameIdEvents(4);
        System.out.println("EVENTS FROM GAME_ID = 4:");
